...
<div class="bike_details"><div id=closing>X</div>
  <iframe class="iframe0" id=iframesrc src="http://localhost/CI_JAM/index.php/bike/view_selected_kids_purchase/1"></iframe>
</div>
...
<script>
  ...
  $(document).ready(function () {
    ...
    $(".show_details").click(function () {
      var id = $(this).attr('id');
      $("#iframesrc").attr('src', "http://localhost/CI_JAM/index.php/bike/view_selected_kids_purchase/" + id);
